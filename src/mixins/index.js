...
import {likeSongOfName,getACollect,increasePlayCount, createPlayHistory } from '../api/index';
...
export const mixin = {
    ...
    methods: {
        ...
        attachImageUrl (srcUrl) {
            return srcUrl? this.$store.state.configure.HOST+srcUrl : this.$store.state.configure.HOST+'/img/avatar/user.jpg';
        },
        //根据歌手歌曲名字模糊查询歌曲
        getSong() {
