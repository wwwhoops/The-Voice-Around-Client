...
export default {
    ...
    methods:{
        ...
        //             console.log(this.songLists,'songLists')
        //         })
        //         .catch(err =>{
        //             console.log(err)
        //         })
        ...
        setRank(){
            if(this.loginIn){
                this.evaluation.songListId = this.songListId;
                this.evaluation.consumerId = this.userId;
                this.evaluation.score = this.rank *2;
